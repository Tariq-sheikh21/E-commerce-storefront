...
const KidProducts = () => {
  ...
  const kidProducts = productsData.allProducts.filter(product => product.category === 'kid');

  return (
<>
<div>
    <img src={Banner_kid} alt='banner' className='px-48 my-10' />
  </div>
    <div className="container mx-auto mt-10 px-4 py-8">
      <h1 className="text-3xl text-blue-600 font-bold text-center mb-8">Kid's Products</h1>
